...
<nav class="navbar navbar-dark navbar-expand-md fixed-top bg-dark">
    <div class="container"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button><a href="home"><img class="d-table-row" src="assets/img/ufazz_00000.png" style="height: 52px;"></a>
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav flex-grow-1 justify-content-between">
                ...
                <li class="nav-item"><a class="nav-link" href="#"></a></li>
            </ul><a href="{{"login"}}" style="border-color: rgb(255,255,255);color: rgb(255,255,255);font-size: 13px;width: 82.5156px;height: -26px;margin-right: -457px;">Log Out</a>
        </div>
        <div class="avatar-bg center" style="margin-top: 5px;width: 30px;height: 30px;"></div>
    </div>
</nav>
<section class="rows">
    <section class="features-boxed" style="height: 120px;background: rgb(238, 244, 247);">
        <div class="container" style="height: 107px;">
            <div class="intro">
                <h2 class="text-center" style="width: 500px;max-width: 100%;">YOUR INFORMATION</h2>
            </div>
        </div>
    </section>
</section>
...
<div class="container">
    <div class="row">
        <div class="col-md-6 col-xl-4" style="height: 427px;">
            <header></header>
            <section class="article-clean"></section>
            <h1 style="font-size: 29px;padding-left: 67px;padding-bottom: 27px;">{{$name->student_name}}</h1>
            <div class="avatar-bg center" style="margin-top: 5px;width: 200px;height: 200px;"></div>
            <header></header>
            <div class="avatar"></div>
            <form action="{{'update_avatar'}}" method="post">
                @csrf
                <input type="file" class="form-control" name="avatar" style="padding-left: 9px;padding-top: 3px;height: 36px;width: 281px;margin-left: 25px;margin-top: 12px;">
                <button class="btn btn-primary btn-block" type= 'submit' style="background: rgb(43,30,190);">submit</button>
            </form>
            <div>
                <div class="col" style="margin-top: 27px;margin-right: -23px;margin-left: 12px;"><a href="{{"password"}}" style="margin-top: -30px;margin-right: 10px;padding-top: 0px;margin-left: 61px;margin-bottom: 11px;">Change a password</a></div>
            </div>
        </div>
        <div class="col-md-6 col-xl-8">
            <h1 style="font-size: 29px;padding-left: 106px;width: -54px max-width:100%;">Average</h1>
            <p style="width: 319px;padding-top: 58px;height: -24px;font-weight: bold;padding-left: 44px;">Your Current average is: 16/20</p>
        </div>
    </div>
</div>
<footer class="page-footer" style="margin-top: 581px;">
    <div class="container">
        <div class="row">
