    ...
    <div class="container"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button><a href="Homepage.html"><img src="assets/img/ufazz_00000.png" style="height: 52px;"></a>
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav flex-grow-1 justify-content-between">
                ...
                <li class="nav-item"><a class="nav-link" href="#"></a></li>
            </ul><a href="{{"session"}}" style="border-color: rgb(255,255,255);color: rgb(255,255,255);font-size: 13px;width: 82.5156px;height: -26px;">Log Out</a><a href="{{"personal"}}"><img src="assets/img/{{$avatar}}" style="width: 33px;height: 33px;border-radius: 50%;" href="{{"personal"}}"></a>
        </div>
    </div>
</nav>
<section class="rows">
            ...
            <div class="row justify-content-center features">
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box" style="height: 277px;"><img src="assets/img/Book.png" style="height: 89px;">
                        ...
                        <p class="description">News about Exams, Grades</p><a class="learn-more" href="{{"courses"}}">Courses »</a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><img src="assets/img/pen.png" style="height: 89px;width: 89px;">
                        <h3 class="name" style="padding-top: 25px;">FEEDBACK</h3>
                        <p class="description">Give Feedback to the lessons</p><a class="learn-more" href="{{route('feedback')}}">Feedback »</a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><img src="assets/img/calculator.png" style="height: 89px;">
                        <h3 class="name" style="padding-top: 25px;">GPA CALCULATOR</h3>
                        <p class="description">Calculate your GPA</p><a class="learn-more" href="#">GPA Calculator »</a>
                    </div>
                </div>
            </div>
        </div>
