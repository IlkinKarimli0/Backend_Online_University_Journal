...
<nav class="navbar navbar-dark navbar-expand-md fixed-top bg-dark">
    <div class="container"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button><a href="Homepage.html"><img class="d-table-row" src="assets/img/ufazz_00000.png" style="height: 52px;"></a>
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav flex-grow-1 justify-content-between">
                <li class="nav-item"><a class="nav-link" href="Homepage.html">Home Page</a></li>
                <li class="nav-item"></li>
                <li class="nav-item"><a class="nav-link" href="#"></a></li>
                <li class="nav-item"><a class="nav-link" href="#"></a></li>
            </ul><a href="Login.html" style="border-color: rgb(255,255,255);color: rgb(255,255,255);font-size: 13px;width: 82.5156px;height: -26px;">Log Out</a>
        </div><a href="Personal.html"><img src="assets/img/studentpicture.jpg" style="height: 33px;width: 33px;border-radius: 50%;"></a>
    </div>
</nav>
<section class="rows">
    <section class="features-boxed" style="height: 120px;background: rgb(238, 244, 247);">
        <div class="container" style="height: 107px;">
            <div class="intro">
                <h2 class="text-center" style="width:500px; max-width:100%;">COURSES</h2>
            </div>
        </div>
    </section>
</section>
<section class="mt-4">
    <div class="container">
        <div class="row">
            <div class="col-xl-12 mb-4" style="margin-top: -16px;">
                <h3 class="text-center" style="margin-left: -9px;margin-bottom: 21px;margin-top: 31px;">Exams and grades</h3>
            </div>                <div class="col-xl-12 mb-3">
