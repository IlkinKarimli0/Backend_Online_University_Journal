...
<head>
    ...
    <title>UFAZ_PERSONAL_ROOM_FINAL</title>
...
<body>
<nav class="navbar navbar-dark navbar-expand-md fixed-top bg-dark" style="height: 68px;">
    <div class="container"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button><a href="{{"home_admin"}}"><img src="assets/img/ufazz_00000.png" style="height: 52px;"></a>
        <div class="collapse navbar-collapse" id="navcol-1">
            <ul class="navbar-nav flex-grow-1 justify-content-between">
                <li class="nav-item"><a class="nav-link" href="{{"home_admin"}}">Home Page</a></li>
                <li class="nav-item"></li>
                <li class="nav-item"><a class="nav-link" href="#"></a></li>
                <li class="nav-item"><a class="nav-link" href="#"></a></li>
            </ul><a href="{{"login"}}" style="border-color: rgb(255,255,255);color: rgb(255,255,255);font-size: 13px;width: 82.5156px;height: -26px;">Log Out</a><a href="{{"personal"}}"><img src="assets/img/studentpicture.jpg" style="width: 33px;height: 33px;border-radius: 50%;" href="{{"personal"}}"></a>
        </div>
    </div>
</nav>
<section class="rows">
    <section class="features-boxed">
        <div class="container">
            <div class="intro">
                <h2 class="text-center">UFAZ PERSONAL ROOM</h2>
            </div>
            <div class="row justify-content-center features">
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box" style="height: 277px;"><img src="assets/img/Book.png" style="height: 89px;">
                        <h3 class="name" style="padding-top: 25px;">COURSES</h3>
                        <p class="description">News about Exams, Grades</p><a class="learn-more" href="{{"courses_admin"}}">Courses »</a>
                    </div>
                </div>
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div class="box"><img src="assets/img/pen.png" style="height: 89px;width: 89px;">
                        <h3 class="name" style="padding-top: 25px;">FEEDBACK</h3>
                        <p class="description">Read feedback from students</p><a class="learn-more" href="{{route('feedback_for_admin')}}">Feedback »</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-6 col-md-3">
                ...
                <ul class="footer-links">
                    <li></li>
                    <li><a>Nizami str 183 Baku Aze</a></li>
                    <li><a><br>Information - info@ufaz.az<br></a></li>
                    <li><a><br>Careers - careers@ufaz.az<br></a></li>
                    <li><a><br>Admission - admissions@ufaz.az<br><br><br></a></li>
                </ul>
            </div>
            <div class="col-6 col-md-3">
                <h4>Social Media</h4>
